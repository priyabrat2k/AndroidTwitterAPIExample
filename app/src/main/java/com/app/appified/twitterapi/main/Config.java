...
public class Config {
    ...
    public static final String KEY_CONSUMER_KEY = "YOUR KEY";
    public static final String KEY_CONSUMER_SECRET = "YOUR SECRET";
    public static final String KEY_CALLBACK_URL = "http://www.appifiedtech.com";
